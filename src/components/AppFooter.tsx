    ...
    <footer className="mt-16 border-t border-surface-variant bg-surface-container-lowest text-on-surface-variant">
      <div className="mx-auto w-full max-w-[var(--spacing-container-max)] px-4 py-8 md:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-12">
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-on-surface">Navigation & Resources</h3>
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-on-surface">Disclaimer</h3>
            <p className="mt-3 text-xs leading-relaxed text-on-surface-variant">
              SNHU Degree Map is an independent, unofficial project. It is not affiliated with, endorsed by, or operated
              by Southern New Hampshire University (SNHU). Confirm degree requirements and prerequisites with the
              official catalog and an academic advisor.
            </p>
            <p className="mt-3 text-[11px] text-outline">
              <Link href="/about" className="hover:text-primary hover:underline font-semibold">
